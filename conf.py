...
# Main package name
PACKAGE_NAME = "treecomp"

# Directory name of package
PACKAGE_DIRECTORY = "treecomp"
...
PACKAGE_SHORT_DESCRIPTION = "Compare directory trees and output unified diff"
...
CONSOLE_SCRIPTS = (["treecomp=treecomp.cli:cli"],)
